...
/**
 * This is the ArrayAdapter I made, so it was possible to set pictures and text in the listview.
 * @author Christopher
 *
 * @param <T>
 */
public class MyArrayAdapter<T> extends ArrayAdapter<T> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (row == null) {
			LayoutInflater inflater = ((BasketActivity) context).getLayoutInflater();
		...
		holder.imgIcon.setImageBitmap(product.getImage() == null ? getBitmapFromAsset(context, "images/test.bmp") : product.getImage());
	...
	class ProductHolder {
		...
		public String toString() {
			return imgIcon.toString() + ":" + txtTitle.getText() + ":" + txtPrice.getText();
		}
	}
}